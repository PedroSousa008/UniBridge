...
export function StudentCareerClient() {
  ...
  const modules = [
    ...
    { href: '/student/career/simulation', label: tr('student.career.simulation'), description: 'Interactive future-life simulator — lifestyle, timeline & what-if', icon: BarChart3 },
